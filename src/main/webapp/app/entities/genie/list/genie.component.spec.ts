...
describe('Genie Management Component', () => {
  let comp: GenieComponent;
  let fixture: ComponentFixture<GenieComponent>;
  let service: GenieService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'genie', component: GenieComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GenieComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.genies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
