...
describe('Soutenance Management Component', () => {
  let comp: SoutenanceComponent;
  let fixture: ComponentFixture<SoutenanceComponent>;
  let service: SoutenanceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'soutenance', component: SoutenanceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SoutenanceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.soutenances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
