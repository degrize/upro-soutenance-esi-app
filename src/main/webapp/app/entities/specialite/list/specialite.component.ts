...
export class SpecialiteComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.specialiteService
      ...
      .subscribe({
        next: (res: HttpResponse<ISpecialite[]>) => {
  ...
  trackId(_index: number, item: ISpecialite): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ISpecialite[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
