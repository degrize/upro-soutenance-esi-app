...
describe('Specialite Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'specialite', component: SpecialiteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.specialites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
