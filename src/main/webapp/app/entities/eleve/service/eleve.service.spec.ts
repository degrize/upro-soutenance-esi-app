...
describe('Eleve Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      dateParcoursDebut: currentDate,
      dateParcoursFin: currentDate,
    };
  });
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          dateParcoursDebut: currentDate.format(DATE_FORMAT),
          dateParcoursFin: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
    ...
    describe('addEleveToCollectionIfMissing', () => {
      ...
      it('should add only unique Eleve to an array', () => {
        const eleveArray: IEleve[] = [{ id: 123 }, { id: 456 }, { id: 76585 }];
