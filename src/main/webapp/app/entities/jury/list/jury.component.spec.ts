...
describe('Jury Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'jury', component: JuryComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.juries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
