...
export class JuryComponent implements OnInit {
  ...
  trackId(_index: number, item: IJury): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IJury[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
