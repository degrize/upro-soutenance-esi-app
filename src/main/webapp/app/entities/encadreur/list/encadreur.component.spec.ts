...
describe('Encadreur Management Component', () => {
  let comp: EncadreurComponent;
  let fixture: ComponentFixture<EncadreurComponent>;
  let service: EncadreurService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'encadreur', component: EncadreurComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(EncadreurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.encadreurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
