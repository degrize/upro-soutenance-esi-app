...
class AnneeAcademiqueResourceIT {
    ...
    public static AnneeAcademique createEntity(EntityManager em) {
        AnneeAcademique anneeAcademique = new AnneeAcademique().anneeScolaire(DEFAULT_ANNEE_SCOLAIRE);
    ...
    public static AnneeAcademique createUpdatedEntity(EntityManager em) {
        AnneeAcademique anneeAcademique = new AnneeAcademique().anneeScolaire(UPDATED_ANNEE_SCOLAIRE);
        return anneeAcademique;
    }
    ...
    void createAnneeAcademique() throws Exception {
        ...
        assertThat(testAnneeAcademique.getAnneeScolaire()).isEqualTo(DEFAULT_ANNEE_SCOLAIRE);
    }
    ...
    void checkAnneeScolaireIsRequired() throws Exception {
        ...
        // set the field null
        anneeAcademique.setAnneeScolaire(null);
    ...
    void putNewAnneeAcademique() throws Exception {
        ...
        updatedAnneeAcademique.anneeScolaire(UPDATED_ANNEE_SCOLAIRE);
        ...
        AnneeAcademique testAnneeAcademique = anneeAcademiqueList.get(anneeAcademiqueList.size() - 1);
        assertThat(testAnneeAcademique.getAnneeScolaire()).isEqualTo(UPDATED_ANNEE_SCOLAIRE);
    }
    ...
    void fullUpdateAnneeAcademiqueWithPatch() throws Exception {
        ...
        partialUpdatedAnneeAcademique.anneeScolaire(UPDATED_ANNEE_SCOLAIRE);
